    ...
    <main>
        <div class="formulario">
            <center>
                ...
                <a type="button" class="btn btn-primary" href="usuario?accion=abrirI">
              ...
              <c:forEach var="usuario" items="${usuario}">         
                    ...
                    <div class="contenido">
                      ...
                      <td>
                        <form action="usuario" method="post" id="formularioEliminar${usuario.getIdUsuario()}">
                            <input type="hidden" name="idUsuario" id="IdFormulario" value="${usuario.getIdUsuario()}">
                            <input type="hidden" name="accion" value="eliminari">
                            <i class="fa-solid fa-trash btnDelete" onclick="EnviarEliminacion('${usuario.getIdUsuario()}')"></i>
                        </form>
                    </td>
                    </tr>
        ...
        <script>
            function EnviarEliminacion(idUsuario) {

            var formEliminado = document.getElementById('formularioEliminar' + idUsuario);
