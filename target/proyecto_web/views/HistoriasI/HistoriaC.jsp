...
<head>
    ...
    <link rel="stylesheet" href="assests/css/Historiai.css">
    ...
    <main>
        <div class="formulario">
            <form action="historias" method="post">
                ...
                <label for="estRol" class="label">Estado de la historia: </label><br>
                </div>
                ...
                <button  class="crear" type="submit" name="accion" value="crearHi">Crear</button>

            </form>
        </div>
        <img src="assests/img/17.png" alt="">
